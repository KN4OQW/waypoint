...
place to start: what it does, how to flash the SD-card image, and the design
documents behind each feature.
...
| Looking for | Go to |
|---|---|
| Flashing the image, first boot | [docs/image.md](https://github.com/KN4OQW/waypoint/blob/main/docs/image.md) |
